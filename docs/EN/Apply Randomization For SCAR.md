...
When designing moveset for some special NPCs, such as boss enemy, you may need to meet the requirements that allow them perform two or more different set of combos attack animations randomly.  
